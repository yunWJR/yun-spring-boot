...
public enum RspDataCodeType {
     ...
     * @return the by code
     */
    public static RspDataCodeType getByCode(Integer code) {
        RspDataCodeType showStatus = null;
        for (int i = 0; i < RspDataCodeType.values().length; i++) {
            showStatus = RspDataCodeType.values()[i];
