...
public class BaseServiceImpl {
    ...
    public <T> T getTokenUser(boolean allowNull) {
        Object obj = AuthDtoUtil.getTokenDto(false);
        if (obj == null) {
            if (allowNull) {
                return null;
            }
    ...
    public <T> T getValidAccessUser() {
        return getAccessUser(false);
    }

    public <T> T getAccessUser(boolean allowNull) {
        Object obj = AuthDtoUtil.getAccessDto(false);
        if (obj == null) {
            if (allowNull) {
                return null;
            }
    ...
    public <T> T getDevice(boolean allowNull) {
        Object obj = AuthDtoUtil.getDeviceDto(false);
        if (obj == null) {
            if (allowNull) {
                return null;
            }
